...
import { MEADOW_POLLEN } from '../weather';

/**
 * Menara Meadows - friendly grassland loop.
 ...
 * ~950 m.
 */
export const menaraMeadows: TrackDefinition = {
  id: 'menara',
  name: 'Menara Meadows',
  theme: 'grassland',
  laps: 3,
  description: 'Olive groves, a long start straight past the pavilion and one hairpin that eats rookies.',
  difficulty: 1,
  controlPoints: [
